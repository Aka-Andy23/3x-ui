...
type IconName = 'dashboard' | 'inbound' | 'team' | 'groups' | 'setting' | 'tool' | 'cluster' | 'hosts' | 'directDomains' | 'logout' | 'apidocs' | 'outbound' | 'routing';
...
export default function AppSidebar() {
  ...
  const tabs = useMemo<{ key: string; icon: IconName; title: string }[]>(() => [
    ...
    { key: '/direct-domains', icon: 'directDomains', title: t('directDomains.menu') },
